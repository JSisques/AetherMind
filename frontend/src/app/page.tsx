...
export default function Home() {
  return (
    <>
      <main className="grid grid-cols-2 items-center justify-items-center min-h-screen p-8 gap-4">
        ...
        <div className="w-[90%]">
          <Image src="/images/profile.jpg" alt="Javier Plaza Sisqués" width={0} height={0} sizes="100vw" className="w-full h-auto" />
        </div>
      </main>
    </>
  );
